	...
	if(isset($_POST["service_submit"]))
		{
			...
			if($check1=='1')
			{
		          ...
		          $sql =  "insert into service(service_name,service_type, service_price, service_description,service_image) values ('$name', 
				'$type','$price', '$details','$target_dir$profilename')";
		  ...
		  <br><br>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="form-sample" enctype='multipart/form-data' name="addserviceform" autocomplete = "off" method = "post" action = "">
				<br>
					<br>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control" style="text-transform:uppercase;" id = "servicename" name="servicename" placeholder="Service Name" required />
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                   ...
                   <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control" id = "serviceprice" name="serviceprice" placeholder="RM 6652.00" required />
                          </div>
                        </div>
                      </div>
                      <div class="col-md-12">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <textarea class="form-control" id="servicedesc" name="servicedesc" placeholder="Enter description here..." required ></textarea>
					...
					<br>
					<button type="submit" name="service_submit" id="service_submit" class="btn btn-gradient-primary mr-2">Add</button>
