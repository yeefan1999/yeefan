...
<?php
	...
	$c = mysqli_query($conn, "select * from customer where c_id = '$id'");
              ...
              <div class="card">
				...
				<br>
					...
					<hr>
					 ...
					 <tr>
					 <td colspan="2">
					 <img src="../../User system/PHP/<?php echo $c1["c_profilepic"]; ?>" style="height:130px; width:130px;">
					 </td>
					 <tr>
					 ...
					 <tr>
					 <th>Customer Name</th>
					 <td><?php echo $c1["c_name"]; ?></td>
					 </tr>
					 
					 <tr>
					 <th>Email Address</th>
					 <td><?php echo $c1["c_email"]; ?></td>
					 </tr>
					 
					 <tr>
					 <th>Contact number</th>
					 <td><?php echo $c1["c_phonenumber"]; ?></td>
					 </tr>
					
					 
					 <tr>
					 <th>Address</th>
					 <td><?php echo $c1["c_address"]; ?></td>
					 </tr>

					 <tr>
					 <th>Postcode</th>
					 <td><?php echo $c1["c_postcode"]; ?></td>
					 </tr>
					 
					 <tr>
					 <th>State</th>
					 <td><?php echo $c1["c_state"]; ?></td>
					 </tr>

					 </table>
					 <br>
					 <br>
					 <a href="customer_list.php"><button class="btn btn-light">Back</button></a>
					<br>
					<br>
					</div>
					</div>
