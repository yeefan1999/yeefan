...
<?php
	...
	$event=mysqli_query($conn,"select * from event where booking_id='$id'"); 

	$event1 = mysqli_fetch_assoc($event);
	
	$package=$event1['package_id'];
	$p=mysqli_query($conn,"select * from package where package_id='$package'"); 
	$p1 = mysqli_fetch_assoc($p);
	$theme=$event1['theme_id'];
	
	$t=mysqli_query($conn,"select * from theme where theme_id='$theme'"); 
	$t1 = mysqli_fetch_assoc($t);
	$service1=$event1['service_id'];
	$s1=mysqli_query($conn,"select * from service where service_id='$service1'"); 
	$s11 = mysqli_fetch_assoc($s1);
	$service2=$event1['service_id2'];
	$s2=mysqli_query($conn,"select * from service where service_id='$service2'"); 
	$s22 = mysqli_fetch_assoc($s2);
	$service3=$event1['service_id3'];
	$s3=mysqli_query($conn,"select * from service where service_id='$service3'"); 
	$s33 = mysqli_fetch_assoc($s3);
?>
<!DOCTYPE html>
<html lang="en">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
		  ...
		  <br><br>
              ...
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Customer's Order Details</h4>
					...
					<br>
					 ...
					 <tr >
					 <th>Event Status</th>
					 <td style="text-transform:uppercase;"><?php echo $book1['booking_status']; ?></td>
					 </tr>
					 
					<?php
					if($book1['booking_status']==('cancelled'))
					{?>
					<tr >
					 <th>Eligible to Refund</th>
					 <td style="text-transform:uppercase;"><?php if($book1['refund_status']=='refund')
					...
					<?php	
					 ...
					 <tr>
					 <th>Name</th>
					 <td style="text-transform:uppercase;"><?php echo $customer1['c_name']; ?></td>
					 </tr>
					 
					<tr>
					 <th>Event Date</th>
					 <td style="text-transform:uppercase;"><?php echo $event1['event_date']; ?></td>
					 </tr>

					
					 <tr>
					 <th>Event Address</th>
					 <td ><?php echo $event1['event_location']; ?></td>
					 </tr>
					 
					 <tr>
					 <th>Event Start Time</th>
					 <td><?php echo $event1['event_start_time']; ?></td>
					 </tr>
					 
					 <tr>
					 <th>Event Start Time</th>
					 <td><?php echo $event1['event_end_time']; ?></td>
					 </tr>
					 </table>
					<?php
					if($book1['booking_status']==('cancelled'))
					{
						...
						if($book1['refund_status']=='refund')
						{	
							$tid=$book1['booking_id'];
							$trans=mysqli_query($conn,"select * from refund where booking_id='$tid'");
							$tr1=mysqli_fetch_assoc($trans);
							...
							<br>
							 ...
							 <td style="text-transform:uppercase;"><?php echo $tr1['refund_name']; ?></td>
							 </tr>
							 ...
							 <td style="text-transform:uppercase;"><?php echo $tr1['refund_bank']; ?></td>
							 </tr>
							 
							<tr>
							 <th>Refund Account Number</th>
							 <td style="text-transform:uppercase;"><?php echo $tr1['refund_account']; ?></td>
							 </tr>
							 
							 <tr>
							 <th>Refund Amount</th>
							 <td style="text-transform:uppercase;">RM <?php echo $tr1['refund_amount']; ?></td>
							 </tr>
							
							<tr>
							 <th>Refund Status</th>
							 <td style="text-transform:uppercase;"><?php echo $tr1['refund_status']; ?></td>
							 </tr>
					...
					<br>
					 ...
					 <tr>
					 <th>Event Package</th>
					 <td><?php echo $p1['package_name']; ?></td>
					 </tr>
					 
					 <tr>
					 <th>Event Package Price</th>
					 <td><?php echo  'RM '.$p1['package_price']; ?></td>
					 </tr>
					 ...
					 <tr>
					 <th>Additional Service 1</th>
					 <td> <?php 
					 if($s11['service_id']!=0)
					 {
					 echo $s11['service_name']; }
					 else
					 {
						 echo '-';
					 }
					 ...
					 <tr>
					 <th>Additional Service 1 Price</th>
					 <td> 
					 <?php 
					 if($s11['service_id']!=0)
					 {
					 echo 'RM '.$s11['service_price']; }
					 else
					 {
						 echo '-';
					 }
					 ...
					 ?></td>
					  ...
					  <tr>
					 <th>Additional Service 2</th>
					 <td> <?php 
					 if($s22['service_id']!=0)
					 {
					 echo $s22['service_name']; }
					 else
					 {
						 echo '-';
					 }
					 ...
					 <tr>
					 <th>Additional Service 2 Price</th>
					 <td> 
					 <?php 
					 if($s22['service_id']!=0)
					 {
					 echo 'RM '.$s22['service_price']; }
					 else
					 {
						 echo '-';
					 }
					 ...
					 ?></td>
					  ...
					  <tr>
					 <th>Additional Service 3</th>
					 <td> <?php 
					 if($s33['service_id']!=0)
					 {
					 echo $s33['service_name']; }
					 else
					 {
						 echo '-';
					 }
					 ...
					 <tr>
					 <th>Additional Service 3 Price</th>
					 <td> 
					 <?php 
					 if($s33['service_id']!=0)
					 {
					 echo 'RM '.$s33['service_price']; }
					 else
					 {
						 echo '-';
					 }
					 ...
					 <tr>
					 <th>Total Bill </th>
					 <td><?php echo  'RM '.$event1['event_price']; ?></td>
					 </tr>
				...
				<br><br>
					 ...
					 if($book1['booking_status']==('cancelled'))
					{
						...
						if($book1['refund_status']=='refund')
						{	?>
					<a href="cancel_action.php?id=<?php echo $book1["booking_id"]; ?>"><button class="btn btn-light"> Update Status</button></a>
					<?php
					}
					}
					?>
					 ...
					 <a href="cancel_completed_order.php"><button class="btn btn-light">Back</button></a>
					<br>
					<br>
					</div>
					</div>
