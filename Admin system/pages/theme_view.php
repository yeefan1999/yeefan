              ...
              <div class="card">
				...
				<br>
					...
					<hr>
					 ...
					 <br>
					 <br>
					 <a href="theme_view.php?id=<?php echo $theme1["theme_id"]?>" onclick="confirmation()"> <button class="btn btn-light">Remove</button></a>
					 <a href="theme_list.php"><button class="btn btn-light">Back</button></a>
					<br>
					<br>
					</div>
					</div>
...
function(isConfirm){
 ...
 <?php
		$_SESSION['var2'] = $theme1["theme_id"];
		
	?>
	 location.href="theme_remove.php";
