...
$book=mysqli_query($conn,"select * from booking where booking_status='cancelled' or booking_status='completed'; "); 
        ...
        <div class="content-wrapper">
		  ...
		  <br><br>
			 ...
			 <div class="col-lg-13 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Customer Order List</h4>
                  <p class="card-description">
                    View the Customer at Once
                  </p>
                  <table id="myTable" class="table table-bordered">
                    <thead>
                      <tr>
                        <th  onclick="sortTable(0)">
                          Customer Name <i class="mdi mdi-sort" >  </i>
                        </th>
                        <th onclick="sortTable(1)">
                          Event Date <i class="mdi mdi-sort" > 
                        </th>
                  
                      
					  <th onclick="sortTable(2)">
					  Event Status <i class="mdi mdi-sort" >
					  </th>
                        <th onclick="sortTable(3)">
                          Refund Request <i class="mdi mdi-sort" >
                        </th>
						<th >
                          Action
                        </th>
					...
					{
						while($book1 = mysqli_fetch_assoc($book))
						{
						$bid=$book1["booking_id"];
						$cid=$book1["c_id"];
						
						$customer=mysqli_query($conn,"select * from customer where c_id='$cid';");
						$c1=mysqli_fetch_assoc($customer);
						
						$event=mysqli_query($conn,"select * from event where booking_id='$bid';");
					...
					?>
                     <tr style="text-transform:uppercase;">
                        ...
                        <td>
                          <?php echo $event1["event_date"]; ?>
                        </td>
                        <td>
                          <?php echo $book1["booking_status"]; ?>
                        </td>
						 <td>
                           <?php 
						   if($book1['booking_status']=='cancelled')
						   {
							 ...
							 $bbbid=$book1['booking_id'];
							 $tr1=mysqli_query($conn,"select * from refund where booking_id='$bbbid'");
							 $tr=mysqli_fetch_assoc($tr1);
							 ?><br><br><?php
							 echo "Refund ".$tr['refund_status'];
							 }
							 else if($book1['refund_status'=='no refund'])
							 {
						...
						<td>
						<br><br>
                          <a href="cc_order.php?id=<?php echo $book1["booking_id"]; ?>"><i class="mdi mdi-view-list"> View Details </i></a>
						  <br><br><br>
						 <?php 
						   if($book1['booking_status']=='cancelled')
						   {?>
						   <a href="cancel_action.php?id=<?php echo $book1["booking_id"]; ?>"><i class="mdi mdi-marker-check"> Manage Cancel Request </i></a><br><br><?php }?>
					<br>
