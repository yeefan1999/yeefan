...
<?php 
	...
	include('../PHPMailer/PHPMailerAutoload.php');
		...
		$query=mysqli_query($conn,"select * from subscriber");
        ...
        <div class="content-wrapper">
          ...
          <div class="row" style="margin-left:50px;">
            <div class="col-md-10 grid-margin stretch-card" >
              <div class="card" >
                <div class="card-body" >
                  <h4 class="card-title" >Send News Form</h4>
                  <p class="card-description">
                   Send the Messages to the subscribers
					<hr>
                  </p>
                  <form name="news"  autocomplete="off" method="post" action="" class="forms-sample" ><br>
                   
				 <div class="col-md-12">
                        <div class="form-group row">
                          <label class="col-sm-12 col-form-label">Description / Remarks</label>
                          <div class="col-sm-12">
						  <br>
                            <textarea class="form-control" id="content" name="content" placeholder="Enter description here..." required ></textarea>
                  ...
                  <br>
				  <br>
                    <button type="submit" name="send" id="send" class="btn btn-gradient-primary mr-2">Send</button>
...
<?php
	if(isset($_POST["send"]))
	{
		if($check == '1')
		{
			echo '<script>swal("Success", "This new is sent to all subscriber!", "success");</script>';
		}
		
		else if($check == '0')
		{
			echo '<script>swal("Error", "Fail to send this new.", "error");</script>';
