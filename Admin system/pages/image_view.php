              ...
              <div class="card">
				...
				<br>
					...
					<hr>
					 ...
					 $ins=mysqli_query($conn,"select * from images where status=1 and package_id='$id'");
					 
					 if(mysqli_num_rows($ins)!=0)
					 {
						 while($ins1=mysqli_fetch_assoc($ins))
						 {
					 ...
					 <tr>
					 <td >
					 <img src="images/upload/<?php echo $ins1["file_name"]; ?>" style="height:130px; width:130px;">
					 </td>
					 <td >
					 <a href="image_remove.php?remid=<?php echo $ins1["id"]; ?>"><i class="mdi mdi-close-box-outline"> Remove </i></a>
					 </td>
					 </tr>
					 <?php }}?>
