	...
	if(isset($_POST["package_submit"]))
		{
			...
			if($check1=='1')
			{
				$sql =  "insert into package(package_name,package_type, package_price, package_description,package_image) values ('$name', 
		  ...
		  <br><br>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="form-sample" enctype='multipart/form-data' name="addpackageform" autocomplete = "off" method = "post" action = "">
				<br>
					<br>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control" style="text-transform:uppercase;" id = "packagename" name="packagename" placeholder="Package Name" required />
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                   ...
                   <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control" id = "packageprice" name="packageprice" placeholder="RM 6652.00" required />
                          </div>
                        </div>
                      </div>
                      <div class="col-md-12">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <textarea class="form-control" id="packagedesc" name="packagedesc" placeholder="Enter description here..." required ></textarea>
					...
					<br>
					<button type="submit" name="package_submit" id="package_submit" class="btn btn-gradient-primary mr-2">Add</button>
