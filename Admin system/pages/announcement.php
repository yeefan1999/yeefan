...
$an=mysqli_query($conn,"select * from announcement where a_date <='$Date2';"); 
	...
	if(isset($_POST["postbtn"]))
	{
		...
		mysqli_query($conn,"insert into announcement(admin_id,a_date,a_description,a_type) values ('$aid','$date','$desc','$type');");
      ...
      <div class="main-panel">
		...
		<div class="row">
           <div class="col-md-3 col-sm-12 col-xs-12">
			...
			<i class="ti-plus"></i> Post Announcement
			</a>
			</div>
			 ...
			 <div class="col-lg-12 grid-margin stretch-card">
                ...
                <div class="card-body">
                  ...
                  <p class="card-description">
                    Look at the important tasks / notices at once
                  </p>
                  <table id="myTable1" class="table table-bordered">
                    <thead>
                      <tr>
                        <th onclick="sortTable(0)">
                          Posted by <i class="mdi mdi-sort" >  </i>
                        </th>
                        <th onclick="sortTable(1)">
                          Date <i class="mdi mdi-sort" > </i>
                        </th>
                        <th onclick="sortTable(2)">
                          Announcement Type <i class="mdi mdi-sort" > </i>
                        </th>
                    ...
                    <tbody>
                     <?php
						while($ann = mysqli_fetch_assoc($an))
						{
						$adid=$ann["admin_id"];
						$ad=mysqli_query($conn,"select * from admin where ad_id='$adid';");
						$ad1=mysqli_fetch_assoc($ad);
					?>
					
						<tr>
                      
                        <td>
                          <?php echo $ad1['ad_name']; ?>
                        </td>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title"><strong>Post</strong> an announcement</h4>
                                ...
                                <form method="post" autocomplete="off" action="">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <textarea name="desc" class="form-control form-white" placeholder="Enter description" /> </textarea>
                                        </div>
									...
									<div class="row">
                                        <div class="col-md-12">
                                            <label class="control-label">Choose Announcement Type</label>
                                            <select name="type" class="form-control form-white" >
                            ...
                            <div class="modal-footer">
                                <button type="submit" name="postbtn" class="btn btn-danger waves-effect waves-light save-category">Add</button>
...
<?php
	if(isset($_POST["postbtn"]))
	{
			...
			echo '<script>swal("Success", "Announcement successfully posted.", "success");</script>';
