...
<?php $admin=mysqli_query($conn,"select * from admin"); ?>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <table class="table table-striped">
                    ...
                    <tbody>
					<?php
						while($admin1 = mysqli_fetch_assoc($admin))
						{
					?>
                      <tr>
                        <td class="py-1">
                          <img src="<?php echo $admin1["ad_profilepic"]; ?>" alt="image"/>
                        </td>
						
                        <td>
                          <?php echo $admin1["ad_name"]; ?>
                        </td>
                      
						<td colspan="2">
                          <a href="admin_action.php?id=<?php echo $admin1["ad_id"]; ?>"><i class="mdi mdi-view-list"> View Details </i></a>
                        </td>
                      </tr>
                       <?php
						}
