                  ...
                  <table id="myTable" class="table table-bordered">
                    <thead>
                      <tr>
                        ...
                        <th onclick="sortTable(0)">
                          Name <i class="mdi mdi-sort" > 
                        </th>
                        <th onclick="sortTable(1)">
                          Email Address <i class="mdi mdi-sort" > 
                        </th>
                        <th onclick="sortTable(2)">
                          Contact Number <i class="mdi mdi-sort" > 
                        </th>
						<th>
                          Action
                        </th>
					...
					?>
                      <tr>
                        ...
                        <td>
                          <?php echo $customer1["c_name"]; ?>
                        </td>
                       
                        <td>
                          <?php echo $customer1["c_email"]; ?>
                        </td>
                        <td>
                          <?php echo $customer1["c_phonenumber"]; ?>
                        </td>
						<td>
                          <a href="customer_action.php?id=<?php echo $customer1["c_id"]; ?>"><i class="mdi mdi-view-list"> View Details </i></a>
                        </td>
                      </tr>
                        <?php
						}
