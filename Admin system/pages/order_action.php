                  ...
                  <h4 class="card-title">Customer's Order Details</h4>
					...
					<br>
					 ...
					 <br>
					  ...
					  <a href="update_action.php?id=<?php echo $book1["booking_id"]; ?>"><button class="btn btn-light"> Update Status</button></a>
					 <a href="customer_order_list.php"><button class="btn btn-light">Back</button></a>
					<br>
					<br>
					</div>
					</div>
