...
$book=mysqli_query($conn,"select * from booking where booking_status!='cart' and booking_status!='completed' and booking_status!='cancelled' "); 
					...
					?>
                     <tr style="text-transform:uppercase;">
						...
						<td>
                          ...
                          <a href="order_action.php?id=<?php echo $book1["booking_id"]; ?>"><i class="mdi mdi-view-list"> View Details </i></a>
						  <br><br><br>
						  <a href="update_action.php?id=<?php echo $book1["booking_id"]; ?>"><i class="mdi mdi-lead-pencil"> Update Status </i></a>
						  <br>
