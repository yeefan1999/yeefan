              ...
              <div class="card">
				...
				<br>
					...
					<hr>
					 ...
					 <br>
					 <br>
					 <a href="service_view.php?id=<?php echo $service1["service_id"]?>" onclick="confirmation()"> <button class="btn btn-light">Remove</button></a>
					 <a href="service_list.php"><button class="btn btn-light">Back</button></a>
					<br>
					<br>
					</div>
					</div>
...
function(isConfirm){
 ...
 <?php
		...
		$_SESSION['var1'] = $service1["service_id"];
		
	?>
	 location.href="service_remove.php";
