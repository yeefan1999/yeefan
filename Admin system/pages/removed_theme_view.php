              ...
              <div class="card">
				...
				<br>
					...
					<hr>
					 ...
					 <tr>
					 <td colspan="2">
					 <img src=" <?php echo $theme1["theme_image"]; ?>" style="height:130px; width:130px;">
					 </td>
					 <tr>
					 ...
					 <tr>
					 <th>Theme Name</th>
					 <td> <?php echo $theme1["theme_name"]; ?></td>
					 </tr>
					 ...
					 <tr>
					 <th>Theme Price</th>
					 <td> <?php echo $theme1["theme_price"]; ?></td>
					 </tr>
					 
					 <tr>
					 <th>Theme Description</th>
					 <td><?php echo $theme1["theme_description"]; ?></td>
					 </tr>
					 ...
					 <br>
					 <br>
					 <a href="removed_theme_view.php?del&id=<?php echo $theme1["theme_id"]?>" onclick="confirmation()"> <button class="btn btn-light">Permanently Removed</button></a>
					 <a href="removed_theme_view.php?rec&id=<?php echo $theme1["theme_id"]?>" onclick="confirmation22()"><button class="btn btn-light">Recover</button></a>
					 <a href="removed_theme.php"><button class="btn btn-light">Back</button></a>
					<br>
					<br>
					</div>
					</div>
...
swal({
  title: "Are you sure?",
  text: "Do you want to permanently delete this theme?",
  type: "warning",
...
function(isConfirm){
  ...
  if (isConfirm) {
     ...
     swal("Deleted!", "This theme is removed.", "success");
	
 <?php

		$_SESSION['theme'] = $theme1["theme_id"];
		
	?>
	 location.href="theme_premove.php";

  } else {
    swal("Cancelled", "This theme is not removed. :)", "error");
  }
});
}
</script>
...
swal({
  title: "Are you sure?",
  text: "Do you want to recover this theme?",
  type: "warning",
  showCancelButton: true,
  confirmButtonColor: "#DD6B55",
...
function(isConfirm){
  ...
  if (isConfirm) {
     ...
     swal("Recovered!", "This theme is recover.", "success");
	
 <?php

		$_SESSION['theme1'] = $theme1["theme_id"];
		
	?>
	 location.href="theme_recover.php";

  } else {
    swal("Cancelled", "This theme is not recovered. :)", "error");
  }
});
}
</script>
