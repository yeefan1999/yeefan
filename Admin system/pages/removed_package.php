...
<?php $package=mysqli_query($conn,"select * from package where package_removed = 1"); ?>
					...
					?>
                      <tr>
						...
						<td>
						  ...
						  <a href="removed_package_view.php?id=<?php echo $package1["package_id"]; ?>"><i class="mdi mdi-view-list"> View Details </i></a>
