...
<?php
	...
	$package1 = mysqli_fetch_assoc($pack);
              ...
              <div class="card">
				...
				<br>
					...
					<hr>
					 ...
					 <tr>
					 <td colspan="2">
					 <img src=" <?php echo $package1["package_image"]; ?>" style="height:130px; width:130px;">
					 </td>
					 <tr>
					 ...
					 <tr>
					 <th>Package Name</th>
					 <td> <?php echo $package1["package_name"]; ?></td>
					 </tr>

					 <tr>
					 <th>Package Type</th>
					 <td> <?php echo $package1["package_type"]; ?></td>
					 </tr>
					 
					 <tr>
					 <th>Package Price</th>
					 <td> <?php echo $package1["package_price"]; ?></td>
					 </tr>
					 
					 <tr>
					 <th>Package Description</th>
					 <td><?php echo $package1["package_description"]; ?></td>
					 </tr>
					 ...
					 <br>
					 <br>
					 <a href="removed_package_view.php?del&id=<?php echo $package1["package_id"]?>" onclick="confirmation()"> <button class="btn btn-light">Permanent Remove</button></a>
						 
					 <a href="removed_package_view.php?rec&id=<?php echo $package1["package_id"]?>" onclick="confirmation22()"><button class="btn btn-light">Recover</button></a>
					  <a href="removed_package.php"><button class="btn btn-light">Back</button></a>
					<br>
					<br>
					</div>
					</div>
...
swal({
  title: "Are you sure?",
  text: "Do you want to permanently delete this package?",
  type: "warning",
...
function(isConfirm){
  ...
  if (isConfirm) {
     ...
     swal("Deleted!", "This package is removed.", "success");
 ...
 <?php
	...
	?>
	 location.href="package_premove.php";

  } else {
    swal("Cancelled", "This package is not removed. :)", "error");
  }
});
}
</script>
...
swal({
  title: "Are you sure?",
  text: "Do you want to recover this package?",
  type: "warning",
  showCancelButton: true,
  confirmButtonColor: "#DD6B55",
...
function(isConfirm){
  ...
  if (isConfirm) {
     ...
     swal("Recovered!", "This package is recover.", "success");
 ...
 <?php
	...
	?>
	 location.href="package_recover.php";

  } else {
    swal("Cancelled", "This package is not recovered. :)", "error");
  }
});
}
</script>
