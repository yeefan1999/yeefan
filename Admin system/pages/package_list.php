...
<?php $package=mysqli_query($conn,"select * from package where package_removed = 0"); ?>
                ...
                <div class="card-body">
                  ...
                  <table id="myTable1" class="table table-bordered">
                    <thead>
					  ...
					  <th>
                        ...
                        <th onclick="sortTable(1)">
                          Package Name <i class="mdi mdi-sort" > </i>
                        </th>
                        <th onclick="sortTable(2)">
                          Package Type <i class="mdi mdi-sort" > </i>
                        </th>
						<th onclick="sortTable(3)">
                          Package Price (RM)<i class="mdi mdi-sort" > </i>
                        </th>
					...
					?>
                      <tr>
                        <td>
                          <img src="<?php echo $package1["package_image"]; ?>" style="height:100px; width:100px;">
                        </td>
                  
                        <td style="text-transform:uppercase;">
                          <?php echo $package1["package_name"]; ?>
                        </td>
                        <td style="text-transform:uppercase;">
                          <?php echo $package1["package_type"]; ?>
                        </td>
                        <td>
                          <?php echo $package1["package_price"]; ?>
                        </td>
					
						
						<td>
						<a href="package_view.php?id=<?php echo $package1["package_id"]; ?>"><i class="mdi mdi-view-list"> View Details </i></a>
						<br><br><br><br>
                          <a href="package_action.php?id=<?php echo $package1["package_id"]; ?>"><i class="mdi mdi-table-edit"> Edit Package</i>
						    <br><br><br><br>
						  <a href="package_image_action.php?id=<?php echo $package1["package_id"]; ?>"><i class="mdi mdi-table-edit"> Upload Multiple Images</i>
						  <br><br><br><br>
						  <a href="image_view.php?id=<?php echo $package1["package_id"]; ?>"><i class="mdi mdi-database">Manage Gallery</i>
