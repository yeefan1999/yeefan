...
<?php
	...
	$tr=mysqli_query($conn,"select * from refund where booking_id='$id'");
...
<?php
	...
	{
		$option=$_POST['status'];
		$result=mysqli_query($conn,"update refund set refund_status='$option' where booking_id='$id';");
	...
	if(isset($_POST["back"]))
	{
		header("Location: cancel_completed_order.php");
	}
       ...
       <div class="main-panel">
        <div class="content-wrapper">
		  ...
		  <br><br>
              ...
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Update Refund Status Form</h4>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-3 col-form-label">Refund Status</label>
                          <div class="col-sm-9">
                            <select class="form-control" id = "status" name="status">
							   <option value="pending" <?php if($tr1["refund_status"] == "pending"){ echo "selected"; } ?>>Pending</option>
                              <option value="completed" <?php if($tr1["refund_status"] == "completed"){ echo "selected"; }?>>Completed</option>
...
<?php
	if(isset($_POST["update"]))
	{
		if($check=='1')
		{ 
		echo '<script>swal("Success", "The status has successfully updated!", "success");</script>';
		$check="";
		}
	}
