                  ...
                  <table id="myTable1" class="table table-bordered">
					...
					?>
                      <tr>
						...
						<td>
						 <a href="service_view.php?id=<?php echo $service1["service_id"]; ?>"><i class="mdi mdi-view-list"> View Details </i></a>
						<br><br><br><br>
                          <a href="service_action.php?id=<?php echo $service1["service_id"]; ?>"><i class="mdi mdi-table-edit"> Edit Package</i>
