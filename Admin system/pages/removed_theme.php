...
<?php $theme=mysqli_query($conn,"select * from theme where theme_removed=1;"); ?>
                ...
                <div class="card-body">
                  ...
                  <table id="myTable1" class="table table-bordered">
					...
					<td>
						  ...
						  <a href="removed_theme_view.php?id=<?php echo $theme1["theme_id"]; ?>"><i class="mdi mdi-view-list"> View Details </i></a>
