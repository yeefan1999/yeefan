              ...
              <div class="card">
				...
				<br>
					...
					<hr>
					 ...
					 <br>
					 <br>
					 <a href="package_view.php?id=<?php echo $package1["package_id"]?>" onclick="confirmation()"> <button class="btn btn-light">Remove</button></a>
						 
					 <a href="package_list.php"><button class="btn btn-light">Back</button></a>
					<br>
					<br>
					</div>
					</div>
...
function(isConfirm){
 ...
 <?php
		...
		$_SESSION['var'] = $package1["package_id"];
		
	?>
	 location.href="package_remove.php";
