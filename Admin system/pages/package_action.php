...
<?php
	...
	if(isset($_POST["package_change"]))
		{
			$id11 = $pack1["package_id"];
			$name = $_POST["packagename"];
			$type = $_POST["packagetype"];
			$price = $_POST["packageprice"];
			$details = $_POST["packagedesc"];
			$check = "";
			$check1="";
			...
			$checkname=mysqli_query($conn,"select * from package where package_name='$name1'");
			$checkname1=mysqli_fetch_assoc($checkname);
			
			$checkname2=mysqli_query($conn,"select * from package where package_id='$id'");
			$checkname3=mysqli_fetch_assoc($checkname2);
			$namenow=$checkname3['package_name'];
			
			$check=strtolower($checkname1['package_name']);
			
			$namechange = $_POST["packagename"];
			...
			if($check1=='1')
			{
					...
					$sql =  "update package set package_name='$name',package_type='$type', package_price='$price',
					package_description='$details',package_image='$target_dir$profilename' where package_id='$id11'";
				...
				{
					$sql =  "update package set package_name='$name',package_type='$type', package_price='$price',
					package_description='$details' where package_id='$id11'";
              ...
              <div class="card">
				...
				<br>
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
							...
							value="<?php echo $pack1["package_name"]; ?>"/>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <select class="form-control" id = "packagetype" name="packagetype">
                              <option value="Wedding" <?php if($pack1["package_type"] == "Wedding"){ echo "selected"; } ?>>Wedding</option>
                              <option value="Birthday" <?php if($pack1["package_type"] == "Birthday"){ echo "selected"; }?>>Birthday</option>
                              <option value="Corporate" <?php if($pack1["package_type"] == "Corporate"){ echo "selected"; }?>>Corporate</option>
                            </select>
                          </div>
                        </div>
                      </div>
                   ...
                   <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-3 col-form-label">Package Price (RM) </label>
                          <div class="col-sm-9">
                            <input type="text" class="form-control" id = "packageprice" name="packageprice" value="<?php echo $pack1["package_price"]; ?>" />
                          </div>
                        </div>
                      </div>
                      <div class="col-md-12">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                              <textarea class="form-control" id="packagedesc" name="packagedesc" ><?php echo $pack1["package_description"]; ?>"</textarea>
					...
					<br>
					<button type="submit" name="package_change" id="package_change" class="btn btn-gradient-primary mr-2">Change</button>
...
<?php
	...
	{
		if($check=='1')
		{ echo '<script>swal("Success", "Package details is succesfully updated!", "success");</script>';
		$check="";
		}

		else if ($check=='0')
		{echo '<script>swal("Error", "Package updated failed. Try again later.", "error");</script>';
		$check="";}
		
		else if ($check=='3')
		{echo '<script>swal("Error", "Package name repeated. Change a name.", "error");</script>';
		$check="";}
		else if ($check=='4')
