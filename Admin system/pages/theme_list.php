                ...
                <div class="card-body">
                  ...
                  <table id="myTable1" class="table table-bordered">
                    <thead>
					  ...
					  <th>
                        ...
                        <th onclick="sortTable(1)">
                          Theme Name <i class="mdi mdi-sort" > </i>
                        </th>
                      
						<th onclick="sortTable(2)">
                          Theme Price (RM)<i class="mdi mdi-sort" > </i>
                        </th>
					...
					?>
                      <tr>
                        <td>
                          <img src="<?php echo $theme1["theme_image"]; ?>" style="height:100px; width:100px;">
                        </td>
                        ...
                        <td>
                          <?php echo $theme1["theme_price"]; ?>
                        </td>
					
						
						<td>
						<a href="theme_view.php?id=<?php echo $theme1["theme_id"]; ?>"><i class="mdi mdi-view-list"> View Details </i></a>
						<br><br><br><br>
                          <a href="theme_action.php?id=<?php echo $theme1["theme_id"]; ?>"><i class="mdi mdi-table-edit"> Edit Package</i>
