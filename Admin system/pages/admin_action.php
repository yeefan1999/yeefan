...
<?php
	...
	$a = mysqli_query($conn, "select * from admin where ad_id = '$id'");
              ...
              <div class="card">
				...
				<br>
					...
					<hr>
					 ...
					 <tr>
					 <td colspan="2">
					 <img src="<?php echo $a1["ad_profilepic"]; ?>" style="height:130px; width:130px;">
					 </td>
					 <tr>
					 ...
					 <tr>
					 <th>Admin Name</th>
					 <td><?php echo $a1["ad_name"]; ?></td>
					 </tr>

					 <tr>
					 <th>Email Address</th>
					 <td><?php echo $a1["ad_address"]; ?></td>
					 </tr>
					 
					 <tr>
					 <th>Contact number</th>
					 <td><?php echo $a1["ad_phonenumber"]; ?></td>
					 </tr>
					 ...
					 <tr>
					 <th>Postcode</th>
					 <td><?php echo $a1["ad_postcode"]; ?></td>
					 </tr>
					 
					 <tr>
					 <th>State</th>
					 <td><?php echo $a1["ad_state"]; ?></td>
					 </tr>
					 		 
					 </table>
					 <br>
					 <br>
					 <a href="admin_list.php"><button class="btn btn-light">Back</button></a>
					<br>
					<br>
					</div>
					</div>
