...
<?php
	...
	$service1 = mysqli_fetch_assoc($ser);
              ...
              <div class="card">
				...
				<br>
					...
					<hr>
					 ...
					 <tr>
					 <td colspan="2">
					 <img src=" <?php echo $service1["service_image"]; ?>" style="height:130px; width:130px;">
					 </td>
					 <tr>
					 ...
					 <tr>
					 <th>Service Type</th>
					 <td> <?php echo $service1["service_type"]; ?></td>
					 </tr>
					 
					 <tr>
					 <th>Service Price</th>
					 <td> <?php echo $service1["service_price"]; ?></td>
					 </tr>
					 
					 <tr>
					 <th>Service Description</th>
					 <td><?php echo $service1["service_description"]; ?></td>
					 </tr>
					 ...
					 <br>
					 <br>
					 <a href="removed_service_view.php?del&id=<?php echo $service1["service_id"]?>" onclick="confirmation()"> <button class="btn btn-light">Permanently Removed</button></a>
					 <a href="removed_service_view.php?rec&id=<?php echo $service1["service_id"]?>" onclick="confirmation22() "><button class="btn btn-light">Recover</button></a>
					 <a href="removed_service.php"><button class="btn btn-light">Back</button></a>
					<br>
					<br>
					</div>
					</div>
...
swal({
  title: "Are you sure?",
  text: "Do you want to permanently delete this service?",
  type: "warning",
...
function(isConfirm){
  ...
  if (isConfirm) {
     ...
     swal("Deleted!", "This service is removed.", "success");
 ...
 <?php
	...
	?>
	 location.href="service_premove.php";

  } else {
    swal("Cancelled", "This service is not removed. :)", "error");
  }
});
}
</script>
...
<script>
function confirmation22()
{
	event.preventDefault();
swal({
  title: "Are you sure?",
  text: "Do you want to recover this service?",
  type: "warning",
  showCancelButton: true,
  confirmButtonColor: "#DD6B55",
...
function(isConfirm){
  ...
  if (isConfirm) {
     ...
     swal("Recovered!", "This service is recover.", "success");
	
 <?php

		$_SESSION['service1'] = $id;
		
	?>
	 location.href="service_recover.php";

  } else {
    swal("Cancelled", "This service is not recovered. :)", "error");
  }
});
}
</script>
