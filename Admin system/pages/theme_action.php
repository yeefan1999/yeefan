...
<?php
	...
	$the = mysqli_query($conn, "select * from theme where theme_id = '$id'");
	$the1 = mysqli_fetch_assoc($the);
	...
	if(isset($_POST["theme_change"]))
		{
			...
			$checkname2=mysqli_query($conn,"select * from theme where theme_id='$id'");
			$checkname3=mysqli_fetch_assoc($checkname2);
			$namenow=$checkname3['theme_name'];
			
			$check=strtolower($checkname1['theme_name']);
			
			$namechange = $_POST["themename"];
			...
			if($check1=='1')
			{
					...
					$sql =  "update theme set theme_id='$id11', theme_name='$name', theme_price='$price',
					theme_description='$details',theme_image='$target_dir$profilename' where theme_id='$id11'";
				...
				{
					$sql =  "update theme set theme_id='$id11', theme_name='$name', theme_price='$price',
					theme_description='$details' where theme_id='$id11'";
      ...
      <div class="main-panel">
        <div class="content-wrapper">
		  ...
		  <br><br>
              ...
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Edit Theme Form</h4>
                  <form class="form-sample" enctype='multipart/form-data' name="chgthemeform" onsubmit="return valiform()" autocomplete = "off" method = "post" action = "">
				<br>
					<br>
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
							...
							value="<?php echo $the1["theme_name"]; ?>"/>
                          </div>
                        </div>
                      </div>
                   ...
                   <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
							...
							id = "themeprice" name="themeprice" value="<?php echo $the1["theme_price"]; ?>" />
                      ...
                      <div class="col-md-12">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                              <textarea class="form-control" id="themedesc" name="themedesc" ><?php echo $the1["theme_description"]; ?>"</textarea>
					...
					<br>
					<button type="submit" name="theme_change" onclick="valiform()" id="theme_change" class="btn btn-gradient-primary mr-2">Change</button>
                    <a href="theme_list.php"><button class="btn btn-light">Cancel</button></a>
					<br>
					</form>
                </div>
              </div>
...
<?php
	if(isset($_POST["theme_change"]))
	{
		...
		{echo '<script>swal("Error", "Theme updated failed. Try again later.", "error");</script>';
		$check="";}
