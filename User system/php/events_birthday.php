    ...
    <body>
                ...
                <nav class="s-header__nav js__scrollbar">
						...
						<ul class="list-unstyled s-header__nav-menu">
						   ...
						   <ul class="list-unstyled s-header__nav-menu">
                            ...
                            <li class="s-header__nav-menu-item"><a class="s-header__nav-menu-link s-header__nav-menu-link-divider -is-active" href="events_birthday.php">Birthday Party</a></li>
        ...
        <div class="s-swiper js__swiper-one-item">
            <!-- Swiper Wrapper -->
                ...
                <div class="g-fullheight--xs g-bg-position--center " style="background: url('img/1920x1080/17.jpg');">
                    <div class="container g-text-center--xs g-ver-center--xs">
                        <div class="g-margin-b-30--xs" style="text-align:left;">
                            <h1 class="g-font-size-35--xs g-font-size-45--sm g-font-size-55--md g-color--white">Celebrate<br>Your Big Day</h1>
                        </div> 
                    </div>
                </div>
     ...
     <div><br><br><br><br></div>
            ...
            <div class="row g-hor-centered-row--md">
                <div class="col-md-8 g-hor-centered-row__col g-margin-b-60--xs g-margin-b-0--md">
                    <div class="g-width-100-percent--xs g-width-400--md g-margin-b-40--xs">
                        <h2 class="g-font-size-32--xs g-font-size-36--md g-font-family--playfair g-margin-b-20--xs">Have Your <br>Unforgettable Birthday Party</h2>
                        <p class="g-font-size-16--sm">Celebrate your big day here! </p>
                        <p class="g-font-size-16--sm">Celebrate your born day together with your friends, family and your lovers!</p>
                    </div>
                    <div class="wow fadeInUp" data-wow-duration=".3" data-wow-delay=".5s">
                        <div class="g-position--overlay g-text-left--xs g-text-right--md g-margin-t-o-50--lg">
                            ...
                            <span class="text-uppercase g-display-block--xs g-font-size-34--xs g-font-size-40--sm g-font-size-50--lg g-font-weight--700 g-font-family--playfair g-color--primary g-line-height--xs">Spend</span>
                            <p class="g-font-size-18--xs g-font-size-20--lg">the Best Times</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-xs-6 col-xs-offset-3 g-full-width--xs g-full-width-offset-0--xs g-hor-centered-row__col">
                    <div class="wow fadeInUp" data-wow-duration=".3" data-wow-delay=".1s">
                        <img class="img-responsive" src="img/450x700/02.jpg" alt="Image">
                    </div>
                </div>
            </div>
        </div>
		...
		<p  style="text-align:center; font-size:50px; color:purple;"> Enjoy The <span style="text-decoration:underline;">Day</span> We Planned </p>
		<p style="line-spacing:5px; font-size:18px; margin-left:120px; margin-right:120px;">
		<br>
		As Birthday can mean a lot for everyone. We always plan the best for every customer to achieve their wants and needs.
		<br>
		<br>
		Our experienced designers and planners take care of every detail for you, delicious catering, fresh cocktails, entertainment that blows
		you away. Our expert team regularly works with the best venues, caterers and suppliers in the industry, and we know how to pull together a 
		stunning occasion to suit your taste. Every little detail is meticulously designed, planned and delivered to create a truly unique birthday celebration!
		<br>
		<br>
		If you are considering a birthday party for your: 16th, 18th, 21st, 30th, 40th, 50th, 60th or 70th birthday – and you want to transform a venue, 
		marquee, house or garden, our fabulous designers will create a spectacular production to take your breath away. Our attention to detail sets us apart 
		from the rest. we’ll make sure your party will be the best one you have been to, and stay with you for the rest of your life! 
		Call us today, and find out what we can do to make your birthday party truly special.
		</p>
