        ...
        <div id="js__scroll-to-section" class="g-container--md g-padding-y-80--xs g-padding-y-125--sm">
            ...
            <div class="row g-margin-b-50--xs">
                <div class="col-sm-6 g-margin-b-30--xs g-margin-b-0--sm">
                    <p>Read this page to see how those common problems fixed and solved.</p>
                    
                    <div class="s-faq__pseudo g-padding-y-40--xs">
                        <p class="g-color--primary g-font-family--playfair"><i>How to plan an event?</i></p>
                        <div class="g-margin-l-70--xs">
                            <p class="g-color--primary g-font-family--playfair"><i>How can Funtastic Event plan my event successfully?</i></p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6">
                        ...
                        <div class="cbp cbp-l-grid-faq js__grid-faq">
                            <div class="cbp-item buying">
                                <div class="cbp-caption">
                                    <div class="s-faq-grid__divider cbp-caption-defaultWrap">
                                        ...
                                        <h2 class="s-faq-grid__title">How to plan an event?</h2>
                                    </div>
                                    <div class="cbp-caption-activeWrap">
                                        <div class="g-color--white-opacity">
                                            Read through our event planning sites. The instructions and process are given in a clear format.
                                            <br>
                                            You can also contact us by submitting the contact form with questions.
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="cbp-item community">
                                <div class="cbp-caption">
                                    <div class="s-faq-grid__divider cbp-caption-defaultWrap">
                                        ...
                                        <h3 class="s-faq-grid__title">Is location of event limited?</h3>
                                    </div>
                                    <div class="cbp-caption-activeWrap">
                                        <div class="g-color--white-opacity">
										You can choose your own event places. Just by filling in the location, if the location is really not suitable or unavailable for us, we will ask you to change to another location.
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="cbp-item buying">
                                <div class="cbp-caption">
                                    <div class="s-faq-grid__divider cbp-caption-defaultWrap">
                                        ...
                                        <h4 class="s-faq-grid__title">How to purchase?</h4>
                                    </div>
                                    <div class="cbp-caption-activeWrap">
                                        <div class="g-color--white-opacity">
                                            You may purchase by using credit or debit card.
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="cbp-item author">
                                <div class="cbp-caption">
                                    ...
                                    <div class="cbp-caption-activeWrap">
                                        <div class="g-color--white-opacity">
                                            We support Visa and Master so far. 
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="cbp-item copyright">
                                <div class="cbp-caption">
                                    <div class="s-faq-grid__divider cbp-caption-defaultWrap">
                                        ...
                                        <h4 class="s-faq-grid__title">How can I customize my own event?</h4>
                                    </div>
                                    <div class="cbp-caption-activeWrap">
                                        <div class="g-color--white-opacity">
                                            We provide you a basic event package, it is on our own how to decorate your event. There is a lot of choices you can make such as emcee,liveband for extra services.
											You may set remarks that speak your ideas.
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="cbp-item author">
                                <div class="cbp-caption">
                                    <div class="s-faq-grid__divider cbp-caption-defaultWrap">
                                        ...
                                        <h4 class="s-faq-grid__title">Historical Event Feedback</h4>
                                    </div>
                                    <div class="cbp-caption-activeWrap">
                                        <div class="g-color--white-opacity">
                                           You may rate the event as your satisfactory. We will read every feedback carefully in order to serve the best for you.
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="cbp-item account">
                                <div class="cbp-caption">
                                    <div class="s-faq-grid__divider cbp-caption-defaultWrap">
                                        ...
                                        <h4 class="s-faq-grid__title">How Do I Change My UserID?</h4>
                                    </div>
                                    <div class="cbp-caption-activeWrap">
                                        <div class="g-color--white-opacity">
                        ...
                        <div class="cbp cbp-l-grid-faq js__grid-faq">
                            <div class="cbp-item account">
                                <div class="cbp-caption">
                                    ...
                                    <div class="cbp-caption-activeWrap">
                                        <div class="g-color--white-opacity">
                                            You may click in user profile -> edit profile -> change password. You have to remember the old password before you done change password.
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="cbp-item author">
                                <div class="cbp-caption">
                                    <div class="s-faq-grid__divider cbp-caption-defaultWrap">
                                        ...
                                        <h4 class="s-faq-grid__title">How If I forgot my password?</h4>
                                    </div>
                                    <div class="cbp-caption-activeWrap">
                                        <div class="g-color--white-opacity">
										You'll be receiving an e-mail in your email account which you used to register. Click on link provided, and then you may reset your password.
										</div>
                                    </div>
                                </div>
                            </div>
                            <div class="cbp-item copyright">
                                <div class="cbp-caption">
                                    <div class="s-faq-grid__divider cbp-caption-defaultWrap">
                                        ...
                                        <h4 class="s-faq-grid__title">How to cancel the event?</h4>
                                    </div>
                                    <div class="cbp-caption-activeWrap">
                                        <div class="g-color--white-opacity">
                                            You have to cancel at least 2 weeks before the event. Short period of cancellation will not receive any refunds.
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="cbp-item copyright">
                                <div class="cbp-caption">
                                    <div class="s-faq-grid__divider cbp-caption-defaultWrap">
                                        ...
                                        <h4 class="s-faq-grid__title">Refund of cancellation</h4>
                                    </div>
                                    <div class="cbp-caption-activeWrap">
                                        <div class="g-color--white-opacity">
										Only 50% of deposit will be refund if cancellation is made.
										</div>
                                    </div>
                                </div>
                            </div>
                            <div class="cbp-item copyright">
                                <div class="cbp-caption">
                                    <div class="s-faq-grid__divider cbp-caption-defaultWrap">
                                        ...
                                        <h4 class="s-faq-grid__title">How do I apply for refund?</h4>
                                    </div>
                                    <div class="cbp-caption-activeWrap">
                                        <div class="g-color--white-opacity">
                                          You have to fill in the refund request form. We will approve the refund if the rules and conditions are met.
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="cbp-item buying">
                                <div class="cbp-caption">
                                    <div class="s-faq-grid__divider cbp-caption-defaultWrap">
                                        ...
                                        <h4 class="s-faq-grid__title">Is my complaints received?</h4>
                                    </div>
                                    <div class="cbp-caption-activeWrap">
                                        <div class="g-color--white-opacity">
                                          We will read every customer's feedback and complaints. We try our best to serve every customer. Please accept our apologizes if any inconveniences or offence caused.
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="cbp-item community">
                                <div class="cbp-caption">
                                    ...
                                    <div class="cbp-caption-activeWrap">
                                        <div class="g-color--white-opacity">
                                           The forum rules and guidelines focus on mutual respect. Customers and Admin should respect on each other.
                                            <br>
