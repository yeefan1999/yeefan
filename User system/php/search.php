...
<html lang="en" class="no-js">
    ...
    <body>
		...
		<nav class="navbar" style="padding-top:13px;">
		  <div class="container-fluid">
			...
			<ul class="nav navbar-nav">
			  ...
			  <div class="dropdown">
			  <button class="dropbtn"><li><a href="package.php" >Event Packages Type</a></li></button>
		...
		?>
		<a href="package_action.php?id=<?php echo $psearch["package_id"]; ?>"><div class="product-grid" >
						<div class="more-product"><span> </span></div>						
						<div class="product-img b-link-stripe b-animate-go  thickbox">
							<img src="../../Admin system/pages/<?php echo $psearch["package_image"]; ?>" class="img-responsive" style="width:350px; height:200px;" alt="">
							<div class="b-wrapper">
						...
						<div class="product-info simpleCart_shelfItem">
							<div class="product-info-cust prt_name">
								<h4> <?php echo $psearch["package_name"]; ?></h4>								
								<span class="item_price">RM <?php echo $psearch["package_price"]; ?></span>
								
								<input type="text" class="item_quantity" value="1" disabled>
								<a href="package_action.php?id=<?php echo $psearch["package_id"]; ?>">
			...
			<?php }
				...
				?>
				<a href="theme_action.php?id=<?php echo $tsearch["theme_id"]; ?>"><div class="product-grid" >
						<div class="more-product"><span> </span></div>						
						<div class="product-img b-link-stripe b-animate-go  thickbox">
							<img src="../../Admin system/pages/<?php echo $tsearch["theme_image"]; ?>" class="img-responsive" style="width:350px; height:200px;" alt="">
							<div class="b-wrapper">
							<h4 class="b-animate b-from-left  b-delay03">							
							<button><span class="glyphicon glyphicon-zoom-in" aria-hidden="true"></span>Quick View</button>
							</h4>
						...
						<div class="product-info simpleCart_shelfItem">
							<div class="product-info-cust prt_name">
								<h4> <?php echo $tsearch["theme_name"]; ?></h4>								
								<span class="item_price">RM <?php echo $tsearch["theme_price"]; ?></span>
								
								<input type="text" class="item_quantity" value="1" disabled>
								<a href="theme_action.php?id=<?php echo $tsearch["theme_id"]; ?>">
								<input type="button" class="item_add items" value="ADD">
								<div class="clearfix"> </div></a>
								<div class="clearfix"> </div>
							</div>												
			...
			<?php
				...
				?>
				<a href="service_action.php?id=<?php echo $ssearch["service_id"]; ?>"><div class="product-grid" >
						<div class="more-product"><span> </span></div>						
						<div class="product-img b-link-stripe b-animate-go  thickbox">
							<img src="../../Admin system/pages/<?php echo $ssearch["service_image"]; ?>" class="img-responsive" style="width:350px; height:200px;" alt="">
							<div class="b-wrapper">
							<h4 class="b-animate b-from-left  b-delay03">							
							<button><span class="glyphicon glyphicon-zoom-in" aria-hidden="true"></span>Quick View</button>
							</h4>
						...
						<div class="product-info simpleCart_shelfItem">
							<div class="product-info-cust prt_name">
								<h4> <?php echo $ssearch["service_name"]; ?></h4>								
								<span class="item_price">RM <?php echo $ssearch["service_price"]; ?></span>
								
								<input type="text" class="item_quantity" value="1" disabled>
								<a href="service_action.php?id=<?php echo $ssearch["service_id"]; ?>">
								<input type="button" class="item_add items" value="ADD">
								<div class="clearfix"> </div></a>
								<div class="clearfix"> </div>
							</div>												
				...
				<?php
					...
					{
						echo "<h2>No Result Found</h2><br><br><h5>Try adjusting your search. Here are some ideas : </h5>
						<br> - Make sure all words are spelled correctly.
						<br> - Try different search terms.
						<br> - Try more general search terms.";
			}}?>
			</div>		
		</div>
