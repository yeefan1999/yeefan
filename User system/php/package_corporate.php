...
<?php $package=mysqli_query($conn,"select * from package where package_type='Corporate' and package_removed=0;"); ?>
...
<html lang="en" class="no-js">
    ...
    <body>
		...
		<nav class="navbar" style="padding-top:13px;">
		  <div class="container-fluid">
			...
			<ul class="nav navbar-nav">
			  ...
			  <div class="dropdown">
			  <button class="btnactive"><li class="active -is-active"><a href="package.php" >Event Packages Type</a></button>
		...
		<div>
			<br><br>
		<h1 style="text-align:center;">Corporate Event Packages </h1>
		</div>
		...
		while($package1 = mysqli_fetch_assoc($package))
			{
		?>
		<a href="package_action.php?id=<?php echo $package1["package_id"]; ?>"><div class="product-grid" >
						<div class="more-product"><span> </span></div>						
						<div class="product-img b-link-stripe b-animate-go  thickbox">
							<img src="../../Admin system/pages/<?php echo $package1["package_image"]; ?>" class="img-responsive" style="width:350px; height:200px;" alt="">
							<div class="b-wrapper">
						...
						<div class="product-info simpleCart_shelfItem">
							<div class="product-info-cust prt_name">
								<h4> <?php echo $package1["package_name"]; ?></h4>								
								<span class="item_price">RM <?php echo $package1["package_price"]; ?></span>
								
								<input type="text" class="item_quantity" value="1" disabled>
								<a href="package_action.php?id=<?php echo $package1["package_id"]; ?>">
