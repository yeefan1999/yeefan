...
<script>
	...
	function validate_card_number()
	{
		...
		if(billing_card_number.value.charAt(0) == 4)
		{
			document.getElementById("final_method").innerHTML = "Visa Card";
		}
		
		else if(billing_card_number.value.charAt(0) == 5)
		{
			document.getElementById("final_method").innerHTML = "Master Card";
		}
		...
		else if(billing_card_number.value.length != 16 || billing_card_number.value.charAt(0) != 4 || billing_card_number.value.charAt(0) != 5)
		{
		...
		<nav class="navbar" style="margin-top:-2px;">
		  <div class="container-fluid" style="background-color:white;">
			<div class="navbar-header">
			  <a class="navbar-brand" href="index.html" style="padding-top:29px;">Funtastic Event</a>
			</div>
			<ul class="nav navbar-nav">
				
			  <div class="dropdown" style="padding-top:10px;">
			  <button class="dropbtn"><li ><a href="package.html" >Event Packages Type</a></button>
			   <div class="dropdown-content">
				<a href="package_wedding.html">Wedding Party / Dinner</a>
				<a href="package_corporate.html">Corporate Dinner</a>
				<a href="package_birthday.html">Birthday Party</a>
			  </div>
			</div>
			  <div class="dropdown">
			  <button class="dropbtn"><li><a href="theme.html" >Theme</a></li></button>
			</div>
			<div class="dropdown">
			  <button class="dropbtn"><li><a href="extra_services.html">Extra Services</a></li></button>
			  </div>
			<div class="dropdown">  
			  <button class="dropbtn"><li><a href="product.html">Other Products</a></li></button>
			  </div>
			</ul>
			<form  style="margin-left:300px;" class="navbar-form navbar-left" action="cart.html">
			  <div class="form-group" style="padding-top:12px;">
				<input type="text" class="form-control" placeholder="Search">
			  </div>
			  <button type="submit" class="btn btn-default" style="margin-top:12px;">Search</button>
			  <button type="submit" class="btn btn-default" style="margin-left:30px; margin-top:12px;"><img src="img/shopping.png" style="width:25px; margin-right:5px;">Shopping Cart</button>
			</form>
		  </div>
		</nav>
		</header>
                ...
                <div class="row g-hor-centered-row--md g-margin-t-900--xs g-margin-t-20	0--sm">
                    <div class="col-lg-6 col-sm-6 g-hor-centered-row__col g-text-center--xs g-text-left--md g-margin-b-60--xs g-margin-b-0--md">
                        ...
                        <div class="wow fadeInUp" data-wow-duration=".3" data-wow-delay=".1s">
                            <form name="paymentform" onsubmit="return validpay()" method="post"
							...
							style="margin:30px;">
                               ...
                               <div class="g-margin-b-30--xs">
								...
								<p><b>Expiry Date</b> 
									...
									name="year" class="form-control s-form-v3__input" style="width:200px; padding-top:25px; font-weight:bold; " placeholder="xxx@example.com"></p>
