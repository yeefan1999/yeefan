...
<?php $package=mysqli_query($conn,"select * from package where package_type='Birthday' and package_removed=0"); ?>
...
<html lang="en" class="no-js">
    ...
    <body>
		...
		<div>
			<br><br>
		<h1 style="text-align:center;">Birthday Event Packages </h1>
		</div>
