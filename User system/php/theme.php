...
<?php $theme=mysqli_query($conn,"select * from theme where theme_removed=0"); ?>
...
<html lang="en" class="no-js">
    ...
    <body>
		...
		<nav class="navbar" style="padding-top:13px;">
		  <div class="container-fluid">
			<div class="navbar-header">
			  <a class="navbar-brand" href="index.html" style="margin-top:5px;">Funtastic Event</a>
			</div>
			<ul class="nav navbar-nav">
			  ...
			  <div class="dropdown">
			  <li class="active -is-active"><a href="theme.php" ><button class="btnactive">Theme</button></a></li>
			</div>
			<div class="dropdown">
			  <li><a href="extra_services.php"><button class="dropbtn">Extra Services</button></a></li>
			  </div>
		...
		while($theme1 = mysqli_fetch_assoc($theme))
			{
		?>
		<a href="theme_action.php?id=<?php echo $theme1["theme_id"]; ?>"><div class="product-grid" >
						<div class="more-product"><span> </span></div>						
						<div class="product-img b-link-stripe b-animate-go  thickbox">
							<img src="../../Admin system/pages/<?php echo $theme1["theme_image"]; ?>" class="img-responsive" style="width:350px; height:200px;" alt="">
							<div class="b-wrapper">
						...
						<div class="product-info simpleCart_shelfItem">
							<div class="product-info-cust prt_name">
								<h4> <?php echo $theme1["theme_name"]; ?></h4>								
								<span class="item_price">RM <?php echo $theme1["theme_price"]; ?></span>
								
								<input type="text" class="item_quantity" value="1" disabled>
								<a href="theme_action.php?id=<?php echo $theme1["theme_id"]; ?>">
